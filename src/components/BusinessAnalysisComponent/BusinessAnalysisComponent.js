      ...
      <div className="after-potential">
        <Container>
            ...
            <Col md="4">
              ...
              <Card className="text-center  align-items-center cardstyleba">
                ...
                <CardText>
                  ...
                  model analysis will figure out the scope of improvements in
                  your business.
                </CardText>
          ...
          <div className="desciption m-3">
            ...
            <ul>
              <li id="bdescrip">
                Strengths are those things which are extremely good in your
                brand and makes you better than your competitors.
              </li>
              <li id="bdescrip">
            ...
            <ul>
              <li id="bdescrip">
                Through Mission we will declare the field of your brand and
                things which your brand wants to achieve in short-term or
                long-term run.
              </li>
              <li id="bdescrip">
            ...
            <ul>
              ...
              <li id="bdescrip">
                Economic factors impact your profit due to market problems but
                we won’t let your business suffer.
              </li>
              <li id="bdescrip">
                Social factors identify beliefs and culture of your customers
                and make better relations with them.
              </li>
              <li id="bdescrip">
                Under Technological factors, we will bring new techniques to
                keep you up to date.
              </li>
              <li id="bdescrip">
                Through Legal factors, we will make sure to keep all your
                services legal.
              </li>
              <li id="bdescrip">
            ...
            <p id="bdescrip">
              ...
              business. System analysis is a way to create the right working
              system by analyzing the main idea behind your business,
              identifying its goals to achieve the desired value. After
              analyzing your business, our team will make you understand the
              problems behind your current status and form a layout to avoid new
              problems and solve the older problems of your business.
            </p>
            ...
            <p id="bdescrip">
              ...
              business, which were hidden before analyzing. It can help you to
              improve different aspects of your business like increasing
              customer value, enhancing product review, handling competition.
              And through this, our team will help you to anticipate your
              revenue and cost as well.
            </p>
          </div>
        </Container>
      </div>
