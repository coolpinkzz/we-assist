  ...
  return (
    <div>
      ...
      <div className="after-potential">
              ...
              <Card className="text-center cardstyle">
                <CardBody>
                  ...
                  <CardText>
                    ...
                    distribution channels to your direct competitors, and even
              ...
              <Card className="text-center cardstyle">
                <CardBody>
                  ...
                  <CardText>
                    ...
                    to many Internet users. It is similar to a traditional
                    mailing list – a list of names and addresses – as might be
                    kept by an organization for sending publications to its
        ...
        <div className="row ptsdescription px-2">
          <Container>
            <h1 id="sales">Sales Funnel</h1>
            <hr />
            <p>
              1. A sales funnel is a step-by-step process that allows you to
              bring your potential customer one step closer to your offer and a
              buying decision through a series of marketing actions like
              automated emails, videos, articles and landing pages that will do
              the selling for you.
            </p>
            <p>
              2. Your sales funnel illustrates the path that prospects take.
              Understanding your funnel can help you find the holes in the
              funnel — the places where prospects drop out and never convert. If
              you don’t understand your sales funnel, you can’t optimize it.
            </p>
            ...
            <div className="row px-3">
              ...
              <p>
                ...
                with paying attention to your competition and what they are
                doing. Understanding what your competition is doing will help
                you position yourself, and your product or service, within the
                market.
              </p>
              <p>
            ...
            <div className="row px-3">
              ...
              <p>
                ...
                There are likely dozens of new opportunities you could pursue
                immediately with the proper amount of analysis.
              </p>
              <p>
                2. Spotting market opportunities is essential for business
                growth and survival. Opportunities are factors that contribute
            ...
            <div className="row px-3">
              ...
              <ul>
                ...
                <li>
                  ...
                  the same. Changing the volume as your email list grows can
                  have a negative effect on your key metrics.
                </li>
              </ul>
            </div>
            ...
            <Col md="4" className="p-2 py-md-5">
              <Card className="text-center h-auto expertcard">
                <CardBody>
                  ...
                  <CardText>
                    A deep understanding of the latest technologies, together
                    with a comprehensive in-house skill set ensures all clients
                    receive the best service. No question is too big, or too
                    small.
                  </CardText>
                </CardBody>
              </Card>
